  ...
  try {
    ...
    if (!box) {
      ...
      box.style.cssText =
        ...
        "padding:14px 16px;color:#F0605A;font-family:'Oswald',sans-serif;font-size:13px;" +
...
/* ---------- design tokens ----------
  ...
  ok:        #4ADE80
  danger:    #F0605A
  display font: 'Oswald' (condensed industrial caps)
  data font:    'JetBrains Mono' (readouts / ids / numbers)
  body font:    Oswald / JetBrains Mono (sem fonte do sistema)
------------------------------------- */
...
function useFonts() {
  useEffect(() => {
    ...
    link.rel = "stylesheet";
    link.href =
      "https://fonts.googleapis.com/css2?family=Oswald:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap";
    document.head.appendChild(link);
  }, []);
}

const MODULES = [
  { key: "novo-relatorio", label: "Novo Relatório", icon: FileText, active: true },
  { key: "historico", label: "Histórico", icon: Clock, active: true },
  { key: "ferramentas", label: "Ferramentas", icon: Sparkles, active: true },
  { key: "documentos", label: "Recibos & Orçamentos", icon: FileCheck2, active: true },
  { key: "pmocs", label: "PMOCs", icon: ClipboardList, active: true },
  { key: "os", label: "Ordens de Serviço", icon: Wrench, active: true },
  { key: "financeiro", label: "Financeiro", icon: BarChart3, active: true },
  { key: "os-frio", label: "OS Frio", icon: Snowflake, active: true },
  { key: "central-whatsapp", label: "Central WhatsApp", icon: MessageCircle, active: true },
  { key: "gestao-inteligente", label: "Gestão Inteligente", icon: BarChart3, active: true },
  { key: "vendas-cervejeira", label: "Vendas Cervejeira", icon: Snowflake, active: true },
  { key: "funcionarios", label: "Funcionários", icon: Users, active: true },
];
      ...
      >
        ...
        {MODULES.map((m) => {
          ...
          return (
            ...
            >
              <Icon size={17} color={m.active ? "#C9A24B" : "#5A5A5A"} strokeWidth={1.8} />
              <span
                style={{
                  fontFamily: "'Oswald',sans-serif",
                  fontSize: 14,
      ...
      {result && (
        ...
        >
          ...
          >
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 32, color: "#E9C878", marginTop: 4 }}>
      ...
      >
        {value.trim() === "" ? (
          ...
          <>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 30, color: "#E9C878", marginTop: 6 }}>
...
function TemperaturaConverter() {
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <button
        onClick={() => setValue("")}
        style={{ width: "100%", marginTop: 14, background: "transparent", border: "1px solid #2A2A2E", borderRadius: 12, padding: "11px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, textTransform: "uppercase", cursor: "pointer" }}
      >
        Limpar
      </button>
    </div>
        ...
        {CALC_CARDS.map((c) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14, fontWeight: 500, color: "#F3F3F1" }}>{c.label}</div>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <Field label="Problema apresentado">
        <textarea
          style={{ ...inputStyle, minHeight: 80, resize: "vertical", fontFamily: "'Oswald',sans-serif" }}
          value={form.problema}
        ...
        <div style={{ marginTop: 18 }}>
          {resultado ? (
            ...
            >
              ...
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 18, fontWeight: 600, color: "#F3F3F1", marginBottom: 10 }}>
                {resultado.nome}
              </div>
              {[
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <Field label="Observações do equipamento">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={equipObs} onChange={(e) => setEquipObs(e.target.value)} />
      </Field>
      ...
      <Field label="Descrição personalizada (opcional)">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={servicoDescricao} onChange={(e) => setServicoDescricao(e.target.value)} />
      </Field>
      ...
      <Field label="O que será executado">
        <textarea style={{ ...inputStyle, minHeight: 80, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={escopoServico} onChange={(e) => setEscopoServico(e.target.value)} placeholder="Ex: Instalação da evaporadora; instalação da condensadora; linha frigorígena; teste de estanqueidade..." />
      </Field>
      <Field label="Não incluso">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={naoIncluso} onChange={(e) => setNaoIncluso(e.target.value)} placeholder="Ex: Obras civis, pintura, materiais adicionais não descritos..." />
      </Field>
      ...
      <Field label="Observações sobre garantia">
        <textarea style={{ ...inputStyle, minHeight: 50, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={garantiaObs} onChange={(e) => setGarantiaObs(e.target.value)} />
      </Field>
      ...
      <Field label="Observações para o cliente (aparece no PDF)">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={obsCliente} onChange={(e) => setObsCliente(e.target.value)} />
      </Field>
      <Field label="Observações internas (NUNCA aparece no PDF do cliente)">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={obsInternas} onChange={(e) => setObsInternas(e.target.value)} />
      </Field>
      ...
      <div style={{ display: "flex", gap: 10 }}>
        <button onClick={onCancel} style={{ flex: 1, background: "transparent", border: "1px solid #2A2A2E", borderRadius: 12, padding: "13px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, textTransform: "uppercase", cursor: "pointer" }}>
          Cancelar
        </button>
        <button
          onClick={() => salvar()}
          disabled={saving || !nome.trim()}
          style={{ flex: 1.4, background: nome.trim() ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "13px 0", color: nome.trim() ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, textTransform: "uppercase", cursor: "pointer" }}
        >
...
function OrcamentoDetail({ orcamento, onBack, onChanged, onEditar, onNovaVersao, onConverterOS }) {
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 19, fontWeight: 600, color: "#F3F3F1", marginBottom: 8 }}>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
        <button onClick={() => setEditandoMsg((v) => !v)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          Editar mensagem
        </button>
        <button onClick={enviarWhatsapp} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
      ...
      {editandoMsg && (
        <textarea
          ...
          style={{ ...inputStyle, minHeight: 130, fontFamily: "'Oswald',sans-serif", marginBottom: 10 }}
        />
      )}

      <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
        <button onClick={() => orcPDF(o)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          <FileText size={14} /> Gerar PDF
        </button>
        <button onClick={() => onNovaVersao(o)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          Duplicar
        </button>
      </div>
      <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
        <button
          ...
          disabled={!podeEditar}
          style={{ flex: 1, background: "#1C1C1F", border: `1px solid ${podeEditar ? "#C9A24B" : "#2A2A2E"}`, borderRadius: 12, padding: "12px 0", color: podeEditar ? "#E9C878" : "#5A5A5A", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: podeEditar ? "pointer" : "default" }}
        >
          {podeEditar ? "Editar" : "Bloqueado (criar nova versão)"}
        </button>
        <button onClick={excluir} style={{ flex: 0.6, background: "rgba(240,96,90,0.1)", border: "1px solid rgba(240,96,90,0.4)", borderRadius: 12, padding: "12px 0", color: "#F0605A", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          Excluir
        </button>
      </div>
...
function OrcamentosModule({ onRefreshApp }) {
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      <button
        onClick={abrirNovo}
        style={{ width: "100%", background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "13px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, color: "#0A0A0B", textTransform: "uppercase", cursor: "pointer", marginBottom: 18 }}
      >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 18 }}>
        {[
          ...
          <div key={label} className="premium-card" style={{ background: "#0D0D0D", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: "13px 14px" }}>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 18, color: "#F5F5F5" }}>{val}</div>
          </div>
        ))}
      </div>
      <div className="premium-card" style={{ background: "#0D0D0D", border: "1px solid rgba(201,162,75,0.3)", borderRadius: 14, padding: "13px 14px", marginBottom: 18, textAlign: "center" }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 24, color: "#C9A24B" }}>{taxaAprovacao}%</div>
      </div>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  ...
                  <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1", marginTop: 2 }}>{o.nome || "Cliente não informado"}</div>
        ...
        {lista === null ? (
          ...
          lista.map((l) => (
            <div key={l.id} style={{ background: "#141416", border: "1px solid #2A2A2E", borderRadius: 12, padding: "13px 14px", marginBottom: 10 }}>
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>{l.nome || "Cliente não informado"}</div>
  ...
  if (mode === "gerado") {
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
          <button onClick={() => setMode("form")} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
            Editar dados
          </button>
          <button onClick={salvar} disabled={saving} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
            {saving ? "Salvando..." : "Salvar"}
          </button>
        </div>
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={enviarWhatsapp} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
            <Send size={14} /> WhatsApp
          </button>
          <button onClick={gerarPDF} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
    ...
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      {[
        ...
        <Field key={k} label={label}>
          <textarea style={{ ...inputStyle, minHeight: 64, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form[k]} onChange={set(k)} />
        </Field>
      ))}
      ...
      <button
        onClick={gerar}
        style={{ width: "100%", marginTop: 6, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "13px 0", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13.5, color: "#0A0A0B", textTransform: "uppercase", cursor: "pointer" }}
      >
        Gerar laudo com IA
      </button>
    </div>
  ...
  return (
    <div>
      ...
      <Field label="Observações">
        <textarea style={{ ...inputStyle, minHeight: 70, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={observacoes} onChange={(e) => setObservacoes(e.target.value)} />
      </Field>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        <button onClick={onCancel} style={{ flex: 1, background: "transparent", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Cancelar
        </button>
        <button
          onClick={() => onSubmit({ status, medicoes, observacoes, fotos, data: new Date().toISOString() })}
          style={{ flex: 1.4, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}
        >
          Concluir manutenção
        </button>
      </div>
...
function PmocDetail({ pmoc, onBack, onUpdated }) {
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 19, fontWeight: 600, color: "#F3F3F1" }}>{current.clienteNome}</div>
      ...
      <button
        ...
        style={{ width: "100%", background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "13px 0", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, color: "#0A0A0B", textTransform: "uppercase", cursor: "pointer", marginBottom: 16 }}
      >
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 8 }}>
        <button onClick={enviarWhatsapp} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          <Send size={13} /> WhatsApp
        </button>
        <button onClick={gerarPDF} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
  ...
  return (
    <div>
      ...
      <Field label="Atividades previstas">
        <textarea style={{ ...inputStyle, minHeight: 70, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.atividades} onChange={set("atividades")} />
      </Field>
      <div style={{ display: "flex", gap: 10 }}>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        ...
        <button onClick={salvar} disabled={saving || !form.clienteNome.trim()} style={{ flex: 1.4, background: form.clienteNome.trim() ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "12px 0", color: form.clienteNome.trim() ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      <button
        ...
        style={{ width: "100%", background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "13px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, color: "#0A0A0B", textTransform: "uppercase", cursor: "pointer", marginBottom: 16 }}
      >
      ...
      {lista === null ? (
        ...
        lista.map((p) => {
          ...
          return (
            ...
            >
              <div>
                <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>{p.clienteNome}</div>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <Field label="Descrição">
        <textarea style={{ ...inputStyle, minHeight: 70, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.descricao} onChange={set("descricao")} />
      </Field>
      <div style={{ display: "flex", gap: 10 }}>
      ...
      <Field label="Observações">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.observacoes} onChange={set("observacoes")} />
      </Field>
      <Field label="Vincular à OS (nº, opcional)">
        <input style={inputStyle} value={form.osVinculada} onChange={set("osVinculada")} />
      </Field>
...
function RecibosEOrcamentosHub({ onNavigate }) {
  ...
  const HubCard = ({ titulo, subtitulo, icone: Icone, contagem, valor, onClick, corIcone }) => (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 17, fontWeight: 600, color: "#F3F3F1" }}>{titulo}</div>
  ...
  if (mode === "detalhe" && selected) {
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 19, fontWeight: 600, color: "#F3F3F1", marginBottom: 12 }}>{r.clienteNome}</div>
        <div style={{ background: "#141416", border: "1px solid #2A2A2E", borderRadius: 14, padding: 16, marginBottom: 16 }}>
          {[
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
          <button onClick={() => reciboWhatsapp(r)} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            <Send size={13} /> WhatsApp
          </button>
          <button onClick={() => reciboPDF(r)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button
            ...
            style={{ flex: 1, background: "#1C1C1F", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}
          >
            Editar
          </button>
          <button onClick={() => remove(r.id)} style={{ flex: 1, background: "rgba(240,96,90,0.1)", border: "1px solid rgba(240,96,90,0.4)", borderRadius: 12, padding: "12px 0", color: "#F0605A", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            Excluir
          </button>
        </div>
      </div>
    ...
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      {recibos === null ? (
        ...
        filtrados.map((r) => (
          ...
          >
            <div>
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>{r.clienteNome}</div>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      {[
        ...
        <Field key={k} label={label}>
          <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form[k]} onChange={set(k)} />
        </Field>
      ))}
      ...
      <Field label="Técnico"><input style={inputStyle} value={form.tecnico} onChange={set("tecnico")} /></Field>
      <div style={{ display: "flex", gap: 10 }}>
        <div style={{ flex: 1 }}><Field label="Data"><input type="date" style={inputStyle} value={form.data} onChange={set("data")} /></Field></div>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        ...
        <button
          ...
          style={{ flex: 1, background: form.clienteNome.trim() ? "#1C1C1F" : "#2A2A2E", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}
        >
          Salvar
        </button>
      </div>
      <button
        ...
        disabled={saving || !form.clienteNome.trim()}
        style={{ width: "100%", marginTop: 10, background: form.clienteNome.trim() ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "13px 0", color: form.clienteNome.trim() ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, textTransform: "uppercase", cursor: "pointer" }}
      >
  ...
  if (mode === "detalhe" && selected) {
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 19, fontWeight: 600, color: "#F3F3F1", marginBottom: 8 }}>{os.clienteNome}</div>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#141416", border: `1px solid ${cor}55`, borderRadius: 20, padding: "5px 12px", marginBottom: 16 }}>
          <span style={{ width: 7, height: 7, borderRadius: "50%", background: cor }} />
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
          <button onClick={() => osWhatsapp(os)} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            <Send size={13} /> WhatsApp
          </button>
          <button onClick={() => osPDF(os)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            <FileText size={13} /> PDF
          </button>
        </div>
        <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
          ...
          <button onClick={() => duplicar(os)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            Duplicar
          </button>
        </div>
        <button onClick={() => remove(os.id)} style={{ width: "100%", background: "rgba(240,96,90,0.1)", border: "1px solid rgba(240,96,90,0.4)", borderRadius: 12, padding: "12px 0", color: "#F0605A", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Excluir OS
        </button>
      </div>
    );
        ...
        lista.map((os) => {
          ...
          return (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>{os.clienteNome}</div>
...
function ReceitaForm({ onDone, onCancel }) {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        <button onClick={onCancel} style={{ flex: 1, background: "transparent", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>Cancelar</button>
        <button onClick={salvar} disabled={saving || !form.valor} style={{ flex: 1.4, background: form.valor && !saving ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "12px 0", color: form.valor && !saving ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: saving ? "default" : "pointer" }}>
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "16px 20px" }}>
        ...
        <div style={{ lineHeight: 1.2 }}>
          <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 21, color: "#F5F5F3", letterSpacing: 0.3 }}>
            Financeiro
          </div>
      ...
      <div style={{ padding: "24px 20px 40px" }}>
          ...
          {cards.map((c) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 25, lineHeight: 1.05, color: c.color, whiteSpace: "nowrap" }}>
                  R$ {c.valor.toFixed(2)}
                </div>
              </div>
            );
        ...
        >
          <div>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 28, color: lucro >= 0 ? "#4ADE80" : "#F0605A" }}>
              R$ {lucro.toFixed(2)}
            </div>
          </div>
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 22, color: lucro >= 0 ? "#4ADE80" : "#F0605A" }}>
              {margem.toFixed(1)}%
            </div>
          </div>
        </div>
            ...
            <div style={{ textAlign: "center", padding: "18px 10px" }}>
              ...
              <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
                <button
                  ...
                  style={{ fontSize: 11.5, padding: "9px 14px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#C9A24B,#E9C878)", color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, cursor: "pointer" }}
                >
                  + Registrar receita
                </button>
                <button
                  onClick={() => setAddMode("despesa")}
                  style={{ fontSize: 11.5, padding: "9px 14px", borderRadius: 10, border: "1px solid #2A2A2E", background: "#1C1C1F", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, cursor: "pointer" }}
                >
                  + Registrar despesa
                </button>
              </div>
        ...
        {/* botoes */}
        <div style={{ display: "flex", gap: 10, marginBottom: 24 }}>
          <button onClick={() => setAddMode("receita")} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "13px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
            <Plus size={15} /> Receita
          </button>
          <button onClick={() => setAddMode("despesa")} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "13px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <Field label="Problema relatado">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.problemaRelatado} onChange={set("problemaRelatado")} />
      </Field>
      <Field label="Diagnóstico">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.diagnostico} onChange={set("diagnostico")} />
      </Field>
      ...
      <Field label="Materiais utilizados">
        <textarea style={{ ...inputStyle, minHeight: 50, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.materiaisUtilizados} onChange={set("materiaisUtilizados")} />
      </Field>
      <Field label="Peças utilizadas">
        <textarea style={{ ...inputStyle, minHeight: 50, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.pecasUtilizadas} onChange={set("pecasUtilizadas")} />
      </Field>
      <Field label="Observações">
        <textarea style={{ ...inputStyle, minHeight: 50, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.observacoes} onChange={set("observacoes")} />
      </Field>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        ...
        <button onClick={() => salvar()} disabled={saving || !form.clienteNome.trim()} style={{ flex: 1, background: form.clienteNome.trim() ? "#1C1C1F" : "#2A2A2E", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Salvar
        </button>
      </div>
      <button
  ...
  if (mode === "detalhe" && selected) {
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
          <button onClick={() => osFrioWhatsapp(os)} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            <Send size={13} /> WhatsApp
          </button>
          <button onClick={() => osFrioPDF(os)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            <FileText size={13} /> PDF
          </button>
        </div>
        <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
          <button onClick={() => { setSelected({ ...os, editing: true }); setMode("novo"); }} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            Editar
          </button>
          <button onClick={() => duplicar(os)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
            Duplicar
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <Field label="Mensagem (editável)">
          <textarea style={{ ...inputStyle, minHeight: 110, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={textoFinal} onChange={(e) => setTextoFinal(e.target.value)} />
        </Field>

        <button
          onClick={enviarWhatsapp}
          style={{ width: "100%", background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "13px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, color: "#0A0A0B", textTransform: "uppercase", cursor: "pointer" }}
        >
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      {WHATSAPP_MODELOS.map((m) => (
        ...
        >
          <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1", marginBottom: 4 }}>{m.nome}</div>
      ...
      <div style={{ padding: "24px 20px 40px", maxWidth: "100%", overflowX: "hidden" }}>
        ...
        >
          <div>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 26, color: "#F5F5F5", lineHeight: 1 }}>
              {clientesAtivos}
            </div>
          </div>
        ...
        {insights.length === 0 ? (
          ...
          >
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#D9D9D6", marginBottom: 6 }}>
...
function ProdutoForm({ onDone, onCancel }) {
  ...
  return (
    <div>
      ...
      <Field label="Descrição">
        <textarea style={{ ...inputStyle, minHeight: 60, resize: "vertical", fontFamily: "'Oswald',sans-serif" }} value={form.descricao} onChange={set("descricao")} />
      </Field>
      <Field label={`Fotos (${fotos.length})`}>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
          {fotos.map((f) => (
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        <button onClick={onCancel} style={{ flex: 1, background: "transparent", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>Cancelar</button>
        <button onClick={salvar} disabled={saving || !form.nome.trim()} style={{ flex: 1.4, background: form.nome.trim() && !saving ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "12px 0", color: form.nome.trim() && !saving ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: saving ? "default" : "pointer" }}>
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <button
          ...
          style={{ flex: 1.4, background: cliente.nome.trim() ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "12px 0", color: cliente.nome.trim() ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}
        >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
        {[
          ...
          <div key={c.label} style={{ background: "#141416", border: "1px solid #2A2A2E", borderRadius: 14, padding: 14 }}>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 19, color: c.color, marginTop: 4 }}>{c.valor}</div>
          </div>
        ))}
      </div>

      <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
        <button onClick={() => setMode("novo-produto")} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          <Plus size={14} /> Produto
        </button>
        <button onClick={() => setMode("nova-venda")} style={{ flex: 1, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}>
          <Plus size={14} /> Venda
        </button>
      </div>
      ...
      {produtos.length === 0 ? (
        ...
        produtos.map((p) => (
          <div key={p.id} style={{ background: "#141416", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 14px", marginBottom: 8, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 13.5, color: "#F3F3F1" }}>{p.nome}</div>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
        ...
        <div>
          <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 18, fontWeight: 600, color: "#F3F3F1" }}>{func.nome}</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
          {[
            ...
            <div key={label} style={{ background: "#141416", border: "1px solid #2A2A2E", borderRadius: 12, padding: 12 }}>
              ...
              <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 18, color: "#F3F3F1", marginTop: 4 }}>{val}</div>
            </div>
          ))}
        </div>
      )}
      ...
      <div style={{ display: "flex", gap: 10 }}>
        <button onClick={() => onEdit(func)} style={{ flex: 1, background: "#1C1C1F", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Editar
        </button>
        <button onClick={remove} style={{ flex: 1, background: "rgba(240,96,90,0.1)", border: "1px solid rgba(240,96,90,0.4)", borderRadius: 12, padding: "12px 0", color: "#F0605A", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Remover
        </button>
      </div>
    </div>
      ...
      {lista === null ? (
        ...
        lista.map((f) => (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14, color: "#F3F3F1" }}>{f.nome}</div>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <Field label="Descrição do serviço">
        <textarea
          style={{ ...inputStyle, minHeight: 90, resize: "vertical", fontFamily: "'Oswald',sans-serif" }}
    ...
    <div style={{ padding: 16, paddingBottom: 40 }}>
      {reports.length === 0 ? (
        ...
        reports.map((r) => (
          ...
          >
            <div>
              <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1", fontWeight: 500 }}>
                {r.cliente || "Cliente não informado"}
              </div>
              <div style={{ fontSize: 12, color: "#8A8A90", marginTop: 3 }}>
...
function EmBreve({ label }) {
  return (
    <div style={{ padding: "70px 24px", textAlign: "center", color: "#6E6E73" }}>
      ...
      <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 16, color: "#C7C9CE", marginBottom: 6 }}>
        {label}
      </div>
    ...
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
        ...
        <button
          ...
          style={{ flex: 1.4, background: !saving && form.cliente.trim() && form.valor ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "12px 0", color: !saving && form.cliente.trim() && form.valor ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: saving ? "default" : "pointer" }}
        >
  ...
  if (mode === "detalhe" && selected) {
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 19, fontWeight: 600, color: "#F3F3F1", marginBottom: 8 }}>{a.cliente}</div>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#141416", border: `1px solid ${cor}55`, borderRadius: 20, padding: "5px 12px", marginBottom: 16 }}>
          <span style={{ width: 7, height: 7, borderRadius: "50%", background: cor }} />
        ...
        <button
          ...
          style={{ width: "100%", marginBottom: 10, background: "linear-gradient(135deg,#C9A24B,#E9C878)", border: "none", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#0A0A0B", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}
        >
          <Send size={14} /> Cobrar pelo WhatsApp
        </button>
        <button onClick={() => setMode("form")} style={{ width: "100%", marginBottom: 10, background: "#1C1C1F", border: "1px solid #C9A24B", borderRadius: 12, padding: "12px 0", color: "#E9C878", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Editar
        </button>
        <button onClick={() => excluir(a.id)} style={{ width: "100%", background: "rgba(240,96,90,0.1)", border: "1px solid rgba(240,96,90,0.4)", borderRadius: 12, padding: "12px 0", color: "#F0605A", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12.5, textTransform: "uppercase", cursor: "pointer" }}>
          Excluir
        </button>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
        {[
          ...
          <div key={label} style={{ background: "#0D0D0D", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: "12px 14px" }}>
            ...
            <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 20, color: cor, marginTop: 3 }}>{val}</div>
          </div>
        ))}
      </div>
        ...
        filtradas.map((a) => {
          ...
          return (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>{a.cliente}</div>
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <button
          ...
          style={{ width: "100%", background: !saving && form.tecnico.trim() ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "13px 0", color: !saving && form.tecnico.trim() ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, textTransform: "uppercase", cursor: saving ? "default" : "pointer" }}
        >
        ...
        lista.map((r) => {
          ...
          return (
            <div key={r.id} style={{ background: "#141416", border: "1px solid #2A2A2E", borderRadius: 12, padding: "13px 14px", marginBottom: 10 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>{r.tecnico}</div>
                  <div style={{ fontSize: 12, color: "#8A8A90", marginTop: 3 }}>
  ...
  if (selecionado) {
    ...
    return (
      <div style={{ padding: 16, paddingBottom: 40 }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 19, fontWeight: 600, color: "#F3F3F1" }}>
          ...
          {eq.eventos.map((ev, i) => {
            ...
            return (
              <div key={i} style={{ position: "relative", marginBottom: 16 }}>
                ...
                <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14, color: "#F3F3F1" }}>{ev.titulo}</div>
      ...
      {equipamentos === null ? (
        ...
        filtrados.map((eq) => (
          <button
            ...
            style={{ width: "100%", textAlign: "left", background: "#141416", border: "1px solid #2A2A2E", borderRadius: 12, padding: "13px 14px", marginBottom: 10, cursor: "pointer" }}
          >
            <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14.5, color: "#F3F3F1" }}>
              {[eq.tipo, eq.marca, eq.modelo].filter(Boolean).join(" ") || "Equipamento"}
            </div>
            <div style={{ fontSize: 12, color: "#8A8A90", marginTop: 3 }}>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      {CHECKLIST_CATEGORIAS.map(({ cat, itens }) => {
        ...
        return (
          <div key={cat} style={{ background: "#0D0D0D", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, marginBottom: 10, overflow: "hidden" }}>
            ...
            >
              <span style={{ fontFamily: "'Oswald',sans-serif", fontSize: 14, color: "#F3F3F1" }}>{cat}</span>
      ...
      <div style={{ background: "linear-gradient(135deg,#151517,#1C1C1F)", border: `1px solid ${conclusao.cor}55`, borderRadius: 16, padding: 18, margin: "18px 0" }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 18, fontWeight: 700, color: conclusao.cor, marginBottom: 8 }}>{conclusao.nivel}</div>
      ...
      <button
        ...
        style={{ width: "100%", background: !saving && cabecalho.cliente.trim() ? "linear-gradient(135deg,#C9A24B,#E9C878)" : "#2A2A2E", border: "none", borderRadius: 12, padding: "13px 0", color: !saving && cabecalho.cliente.trim() ? "#0A0A0B" : "#6E6E73", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 13, textTransform: "uppercase", cursor: saving ? "default" : "pointer" }}
      >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 18 }}>
            {cards.map(([label, valor, cor]) => (
              <div key={label} style={{ background: "#0D0D0D", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: "12px 14px" }}>
                ...
                <div style={{ fontFamily: "'Oswald',sans-serif", fontWeight: 700, fontSize: 19, color: cor, marginTop: 3 }}>{valor}</div>
              </div>
            ))}
          </div>
  ...
  render() {
    ...
    return (
      <div style={{ padding: 28, textAlign: "center", color: "#C7C9CE" }}>
        ...
        <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 17, fontWeight: 600, color: "#F3F3F1", marginBottom: 8 }}>
