    ...
    <div style={{ padding: 16, paddingBottom: 40 }}>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
        <button
          ...
          style={{ flex: 1, background: "#1C1C1F", border: "1px solid #2A2A2E", borderRadius: 12, padding: "12px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#C7C9CE", fontFamily: "'Oswald',sans-serif", fontWeight: 600, fontSize: 12, textTransform: "uppercase", cursor: "pointer" }}
        >
          <Send size={13} /> Enviar
        </button>
